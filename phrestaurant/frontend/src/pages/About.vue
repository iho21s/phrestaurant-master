        ...
        <div class="row">
            <div class="about-content">
                ...
                <div class="about-content-text">
                    <p>Welcome to PHRestaurant, where we are passionate about serving the best Filipino cuisine to our customers. Our restaurant was established with the goal of bringing the authentic flavors of the Philippines to people all around the world..</p>
                    <p>At PHRestaurant, we pride ourselves on using only the freshest and highest quality ingredients to create our dishes. Our talented chefs have years of experience and expertise in preparing traditional Filipino dishes, as well as incorporating modern twists to keep our menu exciting and innovative.</p>
                </div>
            </div>
        </div>
