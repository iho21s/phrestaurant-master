            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="adoboFilterFoodBtn" name="adoboFilterFoodBtn" class="menu-tab-item"
                            value="adobo" @click="filterFoodBtn($event)" />
                        <input type="button" id="sisigFilterFoodBtn" name="sisigFilterFoodBtn" class="menu-tab-item"
                            value="sisig" @click="filterFoodBtn($event)" />
                        ...
                        <input type="button" id="soupFilterFoodBtn" name="soupFilterFoodBtn" class="menu-tab-item"
