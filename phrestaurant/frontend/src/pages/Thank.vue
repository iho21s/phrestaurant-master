...
.thank-container h1 p span {
    position: relative;
    color: #ce4641 !important;
    top: 20px;
    display: inline-block;
    -webkit-animation: bounce 0.3s ease infinite alternate;
    font-size: 80px;
    color: #fff;
    text-shadow: 0 1px 0 #ce4641, 0 2px 0 #ce4641, 0 3px 0 #ce4641, 0 4px 0 #ce4641,
        0 5px 0 #ce4641, 0 6px 0 transparent, 0 7px 0 transparent, 0 8px 0 transparent,
...
@-webkit-keyframes bounce {
    100% {
        top: -20px;
        text-shadow: 0 1px 0 #ce4641, 0 2px 0 #ce4641, 0 3px 0 #ce4641, 0 4px 0 #ce4641,
            0 5px 0 #ce4641, 0 6px 0 #20884b, 0 7px 0 #ce4641, 0 8px 0 #ce4641, 0 9px 0 #ce4641,
