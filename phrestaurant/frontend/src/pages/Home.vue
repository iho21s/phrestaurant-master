    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy Philippines with
                    explosive, sophisticated flavors.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/Pork-Sisig-2-removebg-preview.png" alt="" class="home-img">
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/chicken-adobo-featured-removebg-preview.png" alt="">
                <h3>adobo</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/Pork-Sisig-2-removebg-preview.png" alt="">
                <h3>sisig</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/silog-removebg-preview.png" alt="">
                <h3>silog</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/sizzling-removebg-preview.png" alt="">
                <h3>sizzling</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/bulalo-removebg-preview.png" alt="">
                <h3>Soup</h3>
            </router-link>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/lechon.jpg" alt="">
                    <div class="content">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/chicken-pastel1.png" alt="">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/balbacua.jpg" alt="">
                    <div class="content">
